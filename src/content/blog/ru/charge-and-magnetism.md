...
**Одноимённые заряды (одинаковая хиральность)** — вихри-смерчи с поверхностей вращаются в разные стороны. При встрече верхушками они **несовместимы** — потоки сталкиваются, создавая зону повышенного давления → **отталкивание**.

![Одноимённые заряды — вихри сталкиваются](../../../assets/images/charge_repulsion.png)

**Разноимённые заряды (противоположная хиральность)** — вихри-смерчи вращаются в точке встречи в одном направлении. При встрече верхушками они **совместимы** — потоки сливаются в единые вращающиеся мосты, связывающие обе поверхности → **притяжение**.
