...
> «Я никогда не буду удовлетворен, пока не смогу сделать механическую модель объекта. Если я могу сделать механическую модель — я понимаю это. Если не могу — не понимаю».
>
...
Эксперименты показывают, что атомы вибрируют даже при абсолютном ноле ($T = 0$ K). Квантовая механика объясняет это принципом неопределённости: «Им запрещено останавливаться». Но это не объяснение механизма, это просто запрет задавать вопрос.
...
Струя эфира вылетает в одну сторону — атом толкает в другую. Движение материи — это следствие непрерывной работы эфирных насосов внутри каждого атома.
...
- Эта тяга толкает атом в случайном направлении.
...
- Почему GPS работает именно так.
