...
Today we will:
1. Formulate the **principles of designing** nuclei.
2. Develop **verification methods** — ways to check that the model does not contradict experiments.
...
- *Example 1 — Rutherford's Reaction (1919):* `¹⁴N + α → ¹⁷O + p`
  **Analysis:** The alpha particle knocks out the "weak" proton of the deuteron. If the proton weren't on the outside of the Nitrogen nucleus, the reaction wouldn't proceed so easily.
- *Example 2 — Beryllium-9 Decay:* `⁹Be + α → ¹²C + n`
  **Analysis:** When an alpha particle is added, the "balancing" neutron becomes redundant and is ejected. This confirms that it was not part of the rigid framework of alpha particles.
...
2. Find all "funnels" pointing outward and accessible to external atoms.
3. Count their number — this should match the valency.
*(Why it works: A vortex electron can only enter a strong funnel. The number of strong funnels equals the number of possible bonds).*
...
1. **Determine the composition:** How many protons and neutrons are in the isotope?
2. **Divide into blocks:** How many complete α-particles can be assembled? Is there a remainder (d, p, n)?
3. **Assemble the framework:** Arrange the α-particles considering compactness and orthogonality.
4. **Add superstructures:** Attach deuterons and individual nucleons to free ports.
5. **Verify:** Run the resulting model through the 3 tests (nuclear reactions, valency, molecular angles).
...
- **Step 2. Division:** 6 nucleons = 1 α-particle + remainder (1p + 1n). The remainder is a deuteron! Formula: `⁶Li = α + d`.
- **Step 3. Assembly:** The alpha particle is the central block. A neutron of the α-particle faces the proton of the deuteron. The deuteron attaches to the side.

![Lithium-6 and Lithium-7 Nucleus Diagram](../../../assets/images/Li6-7.png)
...
![Two alpha particles of Beryllium-8](../../../assets/images/Be.png)

**Beryllium-9** (`⁹Be = 2α + n`) is 100% stable!
*The key to stability is the additional neutron:*
1. Two α-particles are arranged in a line and rotated differently.
2. The additional neutron is on the same axis, weighting down the structure.
3. The proton of the left α-particle ejects a flow → it enters the added neutron → a directed tie is formed, rigidly binding both α-particles together.

![Beryllium-9 Nucleus](../../../assets/images/Be9_Final.png)
...
**Boron-10 (¹⁰B = 2α + d)**:
![Boron-10 Nucleus](../../../assets/images/B10.png)

**Boron-11 (¹¹B = 2α + t)**:
![Boron-11 Nucleus](../../../assets/images/B11.png)
...
![Boron-11 Atom](../../../assets/images/B11_atom.png)
...
1. Understand the reasons for the stability or radioactivity of isotopes.
2. Predict chemical properties and molecular shapes.
3. Explain rare nuclear reactions.
